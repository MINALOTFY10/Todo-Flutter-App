...
Widget doneTaskBuilder({required List<TaskModel> tasks, required context}) {
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                            onPressed: () {
                              cubit.deleteData(title: model.title);
                              cubit.page = 2;
                              snackBarMessage(context, "Task is deleted", true);
                            },
                            icon:
                        ...
                        IconButton(
                            onPressed: () {
                              cubit.updateDataType(
                                  type: 'Archived',priority: model.priority, title: model.title);
                              cubit.page = 2;
                              snackBarMessage(
